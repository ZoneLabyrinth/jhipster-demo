...
import { MonolithSharedModule } from 'app/shared';
import { MonolithCoreModule } from 'app/core';
import { MonolithAppRoutingModule } from './app-routing.module';
import { MonolithHomeModule } from './home/home.module';
import { MonolithAccountModule } from './account/account.module';
...
@NgModule({
    imports: [
        ...
        MonolithSharedModule.forRoot(),
        MonolithCoreModule,
        MonolithHomeModule,
        MonolithAccountModule,
